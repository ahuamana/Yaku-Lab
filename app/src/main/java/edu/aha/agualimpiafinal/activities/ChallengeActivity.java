...
import edu.aha.agualimpiafinal.databinding.ActivityChallengeBinding;
        ...
        if (idphoto != null) {
            ...
            if (mImageFileReciever != null) {
                if (!mImageFileReciever.equals("")) {
                    ...
                    mImageProvider.save(this, mImageFileReciever).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        @Override
    ...
    private void updatePhotoFirebase(String url, MaterialTextView textView, String idphoto) {
        ...
        mInsectosProvider.update(idphoto, url).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    textView.setVisibility(View.GONE);
                    Toast.makeText(getApplicationContext(), "Foto actualizado Correctamente", Toast.LENGTH_SHORT).show();
                    mDialog.dismiss();
